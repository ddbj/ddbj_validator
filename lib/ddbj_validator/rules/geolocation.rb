module DDBJValidator
  ...
  module Geolocation
    NE_COUNTRIES_PATH    = DDBJValidator.conf_dir.join('biosample/ne_countries.json').freeze
    INSDC_TO_ISO_A3_PATH = DDBJValidator.conf_dir.join('biosample/insdc_to_iso_a3.json').freeze
